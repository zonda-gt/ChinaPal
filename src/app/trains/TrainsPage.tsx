            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              >
                ...
                >
                  ...
                  Available now — usually replies in 10 min
                </div>

                <h1 className="font-display text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-[1.05] mb-6">
                  China trains,<br />
                  <em className="not-italic" style={{ color: "oklch(0.70 0.18 25)" }}>booked for you.</em>
                </h1>

                <p className="text-sm md:text-xl text-white/80 mb-8 max-w-md leading-relaxed font-body">
                  Tell us your train route. We book it on 12306 in Chinese and send your e-tickets within hours.
                </p>
