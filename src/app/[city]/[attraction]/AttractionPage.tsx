  ...
  return (
    <>
          ...
          <div className="lg:grid lg:grid-cols-[1fr_360px] lg:gap-12">
            ...
            <div className="mt-8 lg:mt-0">
              ...
              <div className="mt-4 bg-white border border-border rounded-2xl p-5 lg:p-6 shadow-md">
                ...
                <div className="text-[26px] font-extrabold text-dark mb-3.5">$49 <span className="text-sm font-normal text-muted">/ trip</span></div>
                <button
                  onClick={() => setConciergeOpen(true)}
      ...
      <section className="bg-dark py-12 lg:py-16">
        <div className="max-w-[1200px] mx-auto px-4 lg:px-10 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
          ...
          <div className="flex-shrink-0 text-center lg:text-right">
            <div className="text-3xl lg:text-4xl font-black text-white mb-4">
              $49 <span className="text-sm font-normal text-white/55">/ trip</span>
            </div>
            <button
              onClick={() => setConciergeOpen(true)}
              className="bg-red text-white border-none px-8 py-4 rounded-xl text-base font-bold cursor-pointer hover:bg-red-dark transition-all hover:-translate-y-0.5 whitespace-nowrap"
            >
              Plan My Visit →
            </button>
          </div>
      ...
      {conciergeOpen && (
        ...
        >
          <div className="bg-white rounded-2xl w-[540px] max-w-[90vw] max-h-[90vh] overflow-y-auto shadow-xl animate-[modalIn_0.25s_ease]">
            <div className="flex justify-between items-start p-6 pb-0">
              <div>
                <h3 className="text-xl font-extrabold text-dark">Plan Your Visit</h3>
                <p className="text-[13px] text-muted mt-0.5">{data.attraction_name_en} • {data.attraction_name_cn}</p>
              </div>
              <button
            ...
            <div className="p-6 pt-5">
              <p className="text-sm text-mid mb-4">
                ChinaPal&apos;s concierge team helps with everything — from booking English-speaking guides to real-time support during your visit.
              </p>
              <div className="grid grid-cols-2 gap-2.5 mb-5">
                {["English guide booking", "Route planning", "Ticket assistance", "Transport arrangement", "Restaurant reservations", "Real-time support"].map((s) => (
                  <div key={s} className="text-[13.5px] text-dark bg-bg px-3.5 py-2.5 rounded-lg border border-border">{s}</div>
                ))}
              </div>
              <div className="flex justify-between items-center bg-dark text-white rounded-xl px-4 py-3.5 mb-3.5">
                <span className="text-sm font-semibold">Concierge service</span>
                <span className="text-xl font-extrabold">$49 / trip</span>
              </div>
              <button
                className="w-full bg-red text-white border-none py-3.5 rounded-xl text-[15px] font-bold cursor-pointer hover:bg-red-dark transition-colors"
              >
                Start Planning →
              </button>
            </div>
