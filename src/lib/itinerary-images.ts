...
export const IMAGE_SLOTS = [
  ...
  { key: "tianzi_preview3", label: "Tianzi Preview 3", description: "Third preview thumbnail for Tianzi Mountain" },
  { key: "show_preview3", label: "Show Preview 3", description: "Third preview thumbnail for Charming Xiangxi Show" },
...
const CDN_DEFAULTS: Record<ImageSlotKey, string> = {
  ...
  tianzi_preview3: "https://d2xsxph8kpxj0f.cloudfront.net/310519663383502924/dCuiiEQEkteYUXqqZRtP5i/zjj-avatar-pillars-JfnwwF7VRiJvmNKdnJuoV2.webp",
  show_preview3: "https://d2xsxph8kpxj0f.cloudfront.net/310519663383502924/dCuiiEQEkteYUXqqZRtP5i/zjj-tujia-weaving-mr8ec3URk5JHRPu8h7Wg67.webp",
